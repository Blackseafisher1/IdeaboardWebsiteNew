...
* **Routenüberblick (Auszug, inkl. Partials/HTMX):**
  ...
  | POST `/ideas/eigen/:commentId/react`                                                                    | Emoji auf Kommentar                                                     | `_comments-section`                                        | Whitelist Emojis, toggelt/ändert                                                       |
  | POST `/ideas/eigen/:id/like?idea_id=...`                                                                | Kommentar-Like (comments-likes.js)                                      | `_comments-section`                                        | Transaktion, Session commentLikes                                                      |
