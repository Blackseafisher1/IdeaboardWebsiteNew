defmodule IdeaBoard.GroupsController do
  ...
  defp handle_index(conn) do
    ...
    html = IdeaBoard.Renderer.render("groups/index.html.heex", %{groups: groups}, conn)
  ...
  defp ws_dispatch(conn) do
    ...
    case action do
      "list" ->
        ...
        html = IdeaBoard.Renderer.render("groups/_chat.html.heex", %{group_id: group_id, messages: messages, user: user}, conn)
      ...
      "send" ->
        ...
        case IdeaBoard.GroupService.send_message(group_id, user.user_id, text) do
          {:ok, msg} ->
            ...
            html = IdeaBoard.Renderer.render("groups/_message.html.heex", %{message: msg, user: user}, conn)
            assign(conn, :rendered_html, html)
      ...
      "history" ->
        ...
        html = IdeaBoard.Renderer.render("groups/_messages.html.heex", %{messages: messages, user: user}, conn)
        assign(conn, :rendered_html, html)
