...
// Ensure a subscription to a channel — subscribe when ready and re-subscribe on ready after reconnects
/**
...
module.exports = {
    ...
    awaitRedisReady,
    ensureSubscribe,
    // Safely stringify payloads (convert BigInt -> number|string) and publish
