...
# Session/security
config :elixirideaboard,
  session_salt: System.get_env("SESSION_SALT", "dev_salt"),
  session_secret: System.get_env("SESSION_SECRET", "dev_secret"),

  secret_key_base: System.get_env("SECRET_KEY_BASE",
    "local_dev_key_base_64_chars_minimum_____________________"
  )

# Optional gate password
config :elixirideaboard,
